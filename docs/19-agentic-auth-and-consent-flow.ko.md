...
## readiness / stop-condition benchmark
좋은 실행은 사용자가 현재 상태를 다음처럼 이해할 수 있게 해야 합니다.
- 지금은 단순 estimate 단계인지
- 구조화된 draft까지는 가능한지
- 실제 submission assist까지 갈 수 있는지
- 아니면 support boundary나 stop condition 때문에 여기서 멈춰야 하는지
