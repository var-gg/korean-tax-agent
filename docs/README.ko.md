...
- [07-consent-model.md](./07-consent-model.md) — 동의 모델
- [11-review-queue.md](./11-review-queue.md) — review queue
...
- [14-open-source-strategy.md](./14-open-source-strategy.md) — 오픈소스 전략
- [15-backlog.md](./15-backlog.md) — backlog
- [23-documentation-language-policy.md](./23-documentation-language-policy.md) — 문서 언어 정책
...
- 상위 문서(Parent)
- 관련 문서(Related)
- 다음 읽기(Next recommended reading)
